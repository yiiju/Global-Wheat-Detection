...
load_from = 'http://download.openmmlab.com/mmdetection/v2.0/ \
             centripetalnet/ \
             centripetalnet_hourglass104_mstest_16x6_210e_coco/ \
             centripetalnet_hourglass104_mstest_16x6_210e_coco \
             _20200915_204804-3ccc61e5.pth'
# model settings
model = dict(
    type='CornerNet',
    backbone=dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='../../input/jsonfile/' + 'trainCOCO.json',
        img_prefix='../../input/global-wheat-detection/' + 'train/',
